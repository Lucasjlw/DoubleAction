...
#define CWeaponFake C_WeaponFake
...
class CWeaponFake : public CWeaponShotgun
{
public:
	DECLARE_CLASS(CWeaponFake, CWeaponShotgun);
...
private:
	...
	CWeaponFake(const CWeaponFake&);
};

IMPLEMENT_NETWORKCLASS_ALIASED(WeaponFake, DT_WeaponFake)

BEGIN_NETWORK_TABLE(CWeaponFake, DT_WeaponFake)
END_NETWORK_TABLE()

BEGIN_PREDICTION_DATA(CWeaponFake)
END_PREDICTION_DATA()

LINK_ENTITY_TO_CLASS(weapon_fake, CWeaponFake);
PRECACHE_WEAPON_REGISTER(weapon_fake);



CWeaponFake::CWeaponFake()
{
}

acttable_t CWeaponFake::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponFake);
